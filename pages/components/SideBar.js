      ...
      <ul class="space-y-2 font-medium">
         <li>
            <Link href="/" class="flex flex-col text-5xl items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
              <span class="ml-3 p-2 self-start font-inspiration">Agustina</span>
              <span class="ml-3 p-2 pr-6 font-inspiration border-solid border-2 border-b-current border-r-current border-t-0 border-l-0">Zanetti</span>
            </Link>
         </li>
         <li>
            <Link href="about" class="flex items-center mt-16 p-2 font-mono text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
               {/* <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"> */}
                  ...
                  <span class="flex-1 ml-3 whitespace-nowrap">Sobre mi</span>
               {/* </a> */}
            </Link>
         </li>
         <li>
            <Link href="contact" class="flex items-center p-2 font-mono text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
               {/* <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"> */}
                  {/* <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg> */}
                  <span class="flex-1 ml-3 whitespace-nowrap">Contáctame</span>
               {/* </a> */}
            </Link>
         </li>
         <li>
